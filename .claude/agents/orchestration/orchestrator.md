...
allowedAgents: context-engineer, planner, junior-engineer, programmer, senior-programmer, senior-architect, orchestrator
model: sonnet
color: purple
---
...
- Use for: Complex algorithms, performance-critical code, advanced patterns requiring deep expertise
- Example: "Implement distributed caching layer with advanced concurrency patterns"

**senior-architect**: Architectural review, high-level design validation
- Use for: Reviewing architectural decisions, validating system design, ensuring best practices
- Example: "Review microservices communication architecture for scalability"
